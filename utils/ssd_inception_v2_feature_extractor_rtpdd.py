...
class SSDInceptionV2FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def extract_features(self, preprocessed_inputs, preprocessed_lidars_front):
    ...
    preprocessed_lidars_front.get_shape().assert_has_rank(4)
      ...
      with slim.arg_scope(self._conv_hyperparams):
        with tf.variable_scope('InceptionV2',
          ...
          _, image_features = inception_v2.inception_v2_base(
              ...
              ops.pad_to_multiple(preprocessed_lidars_front,
...
class SSDInceptionV2FeatureExtractorLate(ssd_meta_arch.SSDFeatureExtractor):
  """SSD Feature Extractor using InceptionV2 features."""
  ...
  def extract_features(self, preprocessed_inputs, preprocessed_lidars_front):
    ...
    with tf.control_dependencies([shape_assert]):
      with slim.arg_scope(self._conv_hyperparams):
        with tf.variable_scope('InceptionV2',
                               reuse=self._reuse_weights) as scope:
          _, image_features = inception_v2_late.inception_v2_base(
              ops.pad_to_multiple(preprocessed_inputs, self._pad_to_multiple),
              ops.pad_to_multiple(preprocessed_lidars_front,
                                  self._pad_to_multiple),
              final_endpoint='Mixed_5c',
