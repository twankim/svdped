...
def inception_v2_base(inputs,
  ...
  with tf.variable_scope(scope, 'InceptionV2', [inputs,lidars_front]):
    with slim.arg_scope(
      ...
      # 224 x 224 x 2 (Lidar frontal image)
      with tf.variable_scope('lidar_front'):
        # Use a normal convolution instead of a separable convolution.
        # (Because input is gray scale)
        net2 = slim.conv2d(
            lidars_front,
            depth(16), [7, 7],
            stride=2,
      ...
      # ---------------------- Merge Start ------------------------
      #TODO: Think about when to merge
      # Concat two channels
