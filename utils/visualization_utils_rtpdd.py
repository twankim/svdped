...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  Args:
    ...
    dists: a list of shape [N]. If dists=None, then this function assumes that
      there is no distance value to be plotted.
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          if dists is None:
            ...
            display_str = 'score: {}% ({:.2f}m)'.format(
                int(100 * scores[i]),dists[i])
