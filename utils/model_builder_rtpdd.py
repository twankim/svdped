...
from utils.ssd_inception_v2_feature_extractor_rtpdd import (SSDInceptionV2FeatureExtractor,
                                                            SSDInceptionV2FeatureExtractorLate)
from utils import losses_builder_rtpdd as losses_builder
from utils import ssd_meta_arch_rtpdd as ssd_meta_arch
from utils import box_predictor_builder_rtpdd as box_predictor_builder
from utils import box_predictor_rtpdd as box_predictor
from utils import post_processing_builder_rtpdd as post_processing_builder

# A map of names to SSD feature extractors.
SSD_FEATURE_EXTRACTOR_CLASS_MAP = {
    'ssd_inception_v2': SSDInceptionV2FeatureExtractor,
    'ssd_inception_v2_late': SSDInceptionV2FeatureExtractorLate,
...
def build(model_config, is_training, dist_config=None):
  ...
  if meta_architecture == 'ssd':
    return _build_ssd_model(model_config.ssd, is_training, dist_config)
...
def _build_ssd_model(ssd_config, is_training, dist_config=None):
  ...
  (classification_loss, localization_loss, distance_loss, 
   classification_weight, localization_weight, distance_weight,
   hard_example_miner) = losses_builder.build(ssd_config.loss, dist_config)
