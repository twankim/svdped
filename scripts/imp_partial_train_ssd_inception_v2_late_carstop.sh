...
MODEL=imp_partial_pre_${MODEL_BASE}
CFG_DIST=configs/cstopp_distance_loss.config
CFG_PIPELINE=configs/imp_partial_a_${MODEL_BASE}.config
...
python train_rtpdd.py \
        ...
        --init_maxpool=True \
        --trainable_scopes=${LNAME_FE}/lidar_front,${LNAME_FE}/merge,${LNAME_BP0},${LNAME_BP1},${LNAME_BP2},${LNAME_BP3},${LNAME_BP4},${LNAME_BP5}
...
MODEL_FIN=imp_partial_${MODEL_BASE}
TRAIN_DIR_FIN=/data/cstopp/tf/${MODEL_FIN}
CFG_PIPELINE_FIN=configs/imp_partial_b_${MODEL_BASE}.config
